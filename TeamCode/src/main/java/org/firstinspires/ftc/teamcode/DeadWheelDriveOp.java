...
@TeleOp(name = "Dead Wheel DriveOp")
public class DeadWheelDriveOp extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            while (opModeIsActive()) {
                ...
                telemetry.addData("leftEncoder: ", initsetup.leftEncoder.getCurrentPosition());
                telemetry.addData("rightEncoder: ", initsetup.rightEncoder.getCurrentPosition());
                telemetry.addData("frontEncoder: ", initsetup.frontEncoder.getCurrentPosition());
                telemetry.update();
            }
        }
    }
